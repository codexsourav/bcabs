...
import { INewLocalCab, setNewLocalCabData } from "../../../../../store/provider/addCabs/AddLocalCabProvider";
import Button from "../../../../../components/Inputbox/Button";
import { toast } from "react-toastify";
import { PickImageFile } from "../../../../../components/picker/ImagePicker";

function AddLocalStep1() {
    const data = useSelector((state: RootState) => state.addlocalcab);
    const dispatch = useDispatch<AppDispatch>();

    const setData = (name: keyof INewLocalCab, value: any) => {
        dispatch(setNewLocalCabData({ name, value }))
    }
