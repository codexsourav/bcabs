...
export const OneWayBookingSchema = new Schema({
...
export const OneWayBookingModel = model('OneWayBooking', OneWayBookingSchema);
export const TmpOneWayBookingModel = model('TmpOneWayBooking', OneWayBookingSchema);


export const createOneWayTmpBooking = async (data) => {
    try {
        const NewTmp = new TmpOneWayBookingModel(data);
